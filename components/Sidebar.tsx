...
const CameraIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-[#F7C873]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setView }) => {
  ...
  return (
    <aside className="w-64 bg-[#1C2541] p-4 flex flex-col h-full">
      <div className="flex items-center mb-8">
         <CameraIcon />
        <h1 className="text-2xl font-bold text-white mr-2">StudioPay</h1>
      </div>
